...
import AdminCourseDetail from "./views/admin/CourseDetail";
...
import GamePlay from "./views/player/GamePlay";
import MyGames from "./views/player/MyGames";
...
const adminCourseDetailRoute = new Route({
  getParentRoute: () => adminRoute,
