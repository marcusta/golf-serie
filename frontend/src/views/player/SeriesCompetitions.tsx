...
export default function SeriesCompetitions() {
  ...
  return (
    <PlayerPageLayout title={series.name} seriesId={seriesId} seriesName={series.name}>
      ...
      {/* Content */}
      <main className="min-h-screen bg-gradient-to-br from-scorecard to-rough/20">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${
                    statusFilter === filter.key
                      ...
                      : "bg-white border border-soft-grey text-charcoal hover:border-turf hover:bg-turf/5"
                  }`}
                >
                  {filter.label}
                  <span
          ...
          {filteredCompetitions?.length === 0 ? (
            <div className="text-center py-12">
              ...
              <Button
                ...
                className="bg-turf hover:bg-fairway text-scorecard rounded"
              >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded overflow-hidden divide-y divide-soft-grey shadow-sm">
                {filteredCompetitions?.map((competition) => {
                  ...
                  return (
                    <Link
                      ...
                      className="block px-4 py-5 hover:bg-turf/5 transition-colors group"
                    >
                      <div className="flex items-start gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap items-center gap-4 text-body-sm text-charcoal/70">
