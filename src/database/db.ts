...
import { AddParticipantDQAndAuditMigration } from "./migrations/038_add_participant_dq_and_audit";
import { AddCompetitionResultsMigration } from "./migrations/039_add_competition_results";
import { MoveStrokeIndexToCoursesMigration } from "./migrations/040_move_stroke_index_to_courses";
import { AddSeriesAdminsMigration } from "./migrations/041_add_series_admins";
import { AddCompetitionOwnershipMigration } from "./migrations/042_add_competition_ownership";
import { AddTourIdToPointTemplatesMigration } from "./migrations/043_add_tour_id_to_point_templates";
...
import { AddCompetitionHandicapSettingsMigration } from "./migrations/061_add_competition_handicap_settings";
import { AddDopedHandicapMigration } from "./migrations/062_add_doped_handicap";
...
export async function initializeDatabase(db: Database): Promise<void> {
  ...
  const migrations = [
    ...
    new AddCompetitionHandicapSettingsMigration(db),
    new AddDopedHandicapMigration(db),
  ];
